/**
 * Three pillars on a plinth — the mark on the ability control at the table,
 * built to the rule the scroll, the pack and the globe follow: solid artwork
 * filled with `currentColor`. The source's own viewBox already sits the
 * drawing centred.
 *
 ...
 */
export default function AbilityPillars({ className = "" }) {
  return (
    <svg
      viewBox="0 0 294 294"
      fill="currentColor"

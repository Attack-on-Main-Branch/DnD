...
/**
 * The suffix lives here, once. `default` is required alongside `template` and
 * cannot be dropped in favour of it: a template applies to CHILD segments only,
 * never to the segment declaring it.
 */
